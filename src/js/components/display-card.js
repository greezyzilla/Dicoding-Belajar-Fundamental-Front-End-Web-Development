        ...
        this.innerHTML = `
            <a href='./details.html?id=${this._movie.id}'>
                <figure class="gap-2 text-sm items-center flex flex-col text-gray-400 transform hover:scale-105 hover:text-white transition ease-out">
                    <div class="shadow-image flex justify-between bg-cover w-40 h-60 rounded-lg hover:shadow-lg" style="background-image: url(${this._movie.poster_path ? `https://image.tmdb.org/t/p/w200/${this._movie.poster_path}` : "https://upload.wikimedia.org/wikipedia/commons/f/fc/No_picture_available.png"});">
