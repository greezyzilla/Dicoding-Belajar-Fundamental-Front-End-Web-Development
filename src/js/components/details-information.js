...
class DetailsInformation extends HTMLElement {
    ...
    render() {
        ...
        this.innerHTML = `
            <img class="h-full" style="object-fit:cover;width: 100vw; position: absolute;z-index:-1; top: 0; left: 0; mask-image: radial-gradient(51.35% 33.53% at 50.62% 33.53%, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0) 100%); -webkit-mask-image: radial-gradient(51.35% 33.53% at 50.62% 33.53%, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0) 100%);" src="https://image.tmdb.org/t/p/original${this._movie.backdrop_path}" alt=${`${this._movie.title} Backdrop`}/>
